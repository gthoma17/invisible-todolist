...
* Generate JWT signing keys
  * `ssh-keygen -t rsa -b 4096 -m PEM -f local_jwtRSA256.key` then
  * `openssl rsa -in local_jwtRSA256.key -pubout -outform PEM -out local_jwtRSA256.key.pub`
...
* Generate a jwt key with algo RS256
  * `SECRET=$(cat ../local_jwtRSA256.key) poetry run python generateJwt.py > ../jwt`
* Load Settings Page
